...
$content = $content.Replace($cssFind, $cssReplace)
...
$pattern = '(?s)<div class="actions">\s*<a class="btn register" href="([^"]+)" target="_blank">📝 Pre-register</a>\s*<a class="btn calendar" href="([^"]+)" target="_blank">📅 Google Calendar</a>\s*<a class="btn calendar outlook" href="([^"]+)" target="_blank">📆 Outlook</a>\s*</div>'

$evaluator = [System.Text.RegularExpressions.MatchEvaluator] {
    param($m)
    $regUrl = $m.Groups[1].Value
    $calUrl = $m.Groups[2].Value
    $outUrl = $m.Groups[3].Value
    return @"
<div class="actions">
<a class="btn register" href="$regUrl" target="_blank">
...
<a class="btn calendar" href="$calUrl" target="_blank">
...
<a class="btn calendar outlook" href="$outUrl" target="_blank">
